...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tanggalIndo = DateFormat('d MMM yyyy', 'id_ID');
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      rupiah.format(controller.monthlyTotal),
                    ...
                    Text(
                      rupiah.format(controller.yearlyTotal),
                    ),
                  ],
                ),
              ),
                              ...
                              onPressed: () {
                                Get.dialog(
                                  AlertDialog(
                                    ...
                                    content: Text(
                                        "Apakah Anda yakin ingin menghapus subscription \"${sub.name}\"?\n\n"),
                                    actions: [
                                      TextButton(
                                        onPressed: () => Get.back(),
